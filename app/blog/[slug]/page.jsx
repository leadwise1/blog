...
export default async function BlogPost({ params }) {
  ...
  return (
    <article className="bg-white min-h-screen pb-20">
      ...
      {/* Header Image & Title */}
     <header className="flex flex-col items-center justify-center h-[60vh] relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-4 drop-shadow-md text-center">
            {post.title}
          </h1>
          <div className="flex flex-col items-center text-black-900 text-sm font-medium text-center space-y-1">
            <span>{post.date}</span>
            <span>•</span>
